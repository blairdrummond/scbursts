...
record_c <- risetime.correct_gaussian(Tr=35.0052278,record, units="us")
...
bursts <- bursts.defined_by_tcrit(record_c , 0.1, units="ms")
...
record_c <- risetime.correct_gaussian(Tr=35.0052278,record, unit="us")
